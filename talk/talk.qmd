...
![](./images/brain_behavior_scatterplot.png){.absolute top=15% left=20% height=80%}


::: {.absolute top=0% left=5% style="font-size: 2em; text-align: center;"}
What do correlations between brain function/structure and behavior mean?
:::
...
::: {.absolute top=80% left=5% style="font-size: 1em; text-align: center;"}
George et al., 2020
:::
...
This allows understanding of the unique contributions of time on task and condition differences
:::
...
::: {.absolute top=30% left=5% style="font-size: 2em; text-align: center;"}
Anything that correlates with RT can then correlate with activation
:::
