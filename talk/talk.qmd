...
::: {.absolute top=97% left=0% style="font-size: 0.7em; text-align: center;"}
Mumford et al, 2023
:::
...
::: {.absolute top=97% left=0% style="font-size: 0.8em; text-align: center;"}
Mumford et al, 2023
:::
...
::: {.absolute top=97% left=65% style="font-size: 1em; text-align: center;"}
Mumford et al, 2023
:::
...
::: {.absolute top=97% left=0% style="font-size: 1em; text-align: center;"}
Mumford et al, 2023
:::
...
::: {.absolute top=75% left=0% style="font-size: 1.5em; text-align: center;"}
...
![](./images/stroop_stroop_incong_minus_cong_ConsDurNoRT.png){.absolute top=30% left=15% height=20%}
...
![](./images/stroop_stroop_incong_minus_cong_ConsDurRT.png){.absolute top=30% left=60% height=20%}
...
![](./images/twoByTwo_task_switch_cost_100_ConsDurNoRT.png){.absolute top=50% left=15% height=20%}

![](./images/twoByTwo_task_switch_cost_100_ConsDurRT.png){.absolute top=50% left=60% height=20%}
...
![](./images/stopSignal_stop_failure-go_ConsDurNoRT.png){.absolute top=70% left=15% height=20%}

![](./images/stopSignal_stop_failure-go_ConsDurRT.png){.absolute top=70% left=60% height=20%}
